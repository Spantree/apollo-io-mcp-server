...
class Organization(BaseModel):
    ...
    secondary_industries: Optional[List[Any]] = Field(default=None, description="secondary_industries")
    ...
    retail_location_count: Optional[int] = Field(default=None, description="retail_location_count")
    raw_address: Optional[str] = Field(default=None, description="raw_address")
    ...
    suborganizations: Optional[List[Any]] = Field(default=None, description="suborganizations")
    num_suborganizations: Optional[int] = Field(default=None, description="num_suborganizations")
    ...
    funding_events: Optional[List[Dict[str, Any]]] = Field(default=None, description="funding_events")
    technology_names: Optional[List[str]] = Field(default=None, description="technology_names")
    current_technologies: Optional[List[Dict[str, Any]]] = Field(default=None, description="current_technologies")
    org_chart_root_people_ids: Optional[List[str]] = Field(default=None, description="org_chart_root_people_ids")
